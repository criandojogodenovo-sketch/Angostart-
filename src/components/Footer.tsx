          ...
          <div>
            ...
            <div className="mt-5 flex gap-3">
              <a
                ...
                className="rounded-full bg-white/10 p-2.5 transition-colors hover:bg-emerald-500 hover:text-white"
              >
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+244923456789" className="hover:text-white">
                  +244 923 456 789
                </a>
              </li>
              <li className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="mt-6 rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-4">
              <p className="text-xs leading-relaxed text-emerald-300">
                Pagamento por transferência (BAI, BFA), Multicaixa Express e
                dinheiro na entrega.
              </p>
            </div>
          </div>
